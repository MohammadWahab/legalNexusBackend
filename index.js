...
const connection = mysql.createConnection({
  host: `35.238.39.138`,
  user: `wahab`,
  password: `Zero2infinity!`,
  database: `lawyer_consultancy`,
});
...
app.get("/documents", (req, res) => {
  res.send([
    { fileName: "i2.png", filePath: "http://localhost:8000/uploads/i2.png" },
    {
      fileName: "chapter_1.pdf",
      filePath: "http://localhost:8000/uploads/chapter_1.pdf",
    },
  ]);
});
